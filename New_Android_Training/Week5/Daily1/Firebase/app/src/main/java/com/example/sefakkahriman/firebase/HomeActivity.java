...
import com.example.sefakkahriman.firebase.manager.AuthManager;
import com.example.sefakkahriman.firebase.manager.RemoteDatabaseManager;
import com.example.sefakkahriman.firebase.model.Person;
...
public class HomeActivity extends AppCompatActivity implements AuthManager.Callback{
    ...
    protected void onStart() {
        ...
        IntentFilter intentFilter = new IntentFilter("firebase");
    ...
    private void showDiolog(final String postId, final String postMessage) {
