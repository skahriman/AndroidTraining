package com.sefakkahriman.employeecontentprovider.provider;
...
import com.sefakkahriman.employeecontentprovider.helper.EmployeeDataBaseHelper;
...
public class EmployeeContentProvider extends ContentProvider {
    ...
    String[] tableColumns = {EmployeeContract.COLUMN_ID, EmployeeContract.COLUMN_NAME,EmployeeContract.COLUMN_PHONE};
