package com.example.sefakkahriman.customviews.view;
...
import com.example.sefakkahriman.customviews.R;
...
public class MyCircleView extends View {
    ...
    public void init(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.MyCircleView);

        radius = typedArray.getInt(R.styleable.MyCircleView_radius, 0);
        fillColor = typedArray.getInt(R.styleable.MyCircleView_fillColor, 0);
